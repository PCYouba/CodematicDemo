<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Addtype.aspx.cs" Inherits="newsUI.Addtype" %>
...
<form action="#" runat="server" method="post" class="definewidth m20" enctype="multipart/form-data">  
 <font color="#777777"><strong>增加类别：</strong></font>  <asp:Label ID="LabelResule" runat="server" Text="操作提示："></asp:Label>
<table style="margin-left:10px;margin-top:3px;">
    ...
    <tr>
       ...
       <td class="auto-style1">
             <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="保存" /> &nbsp;&nbsp; <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" Text="返回" Height="26px" /> 
