<%@ Page Title="newsInfo" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="rr2.Web.newsInfo.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="newsCount" HeaderText="newsCount" SortExpression="newsCount" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="newsReleaseTime" HeaderText="newsReleaseTime" SortExpression="newsReleaseTime" ItemStyle-HorizontalAlign="Center"  /> 
