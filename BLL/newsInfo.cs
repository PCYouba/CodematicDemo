...
namespace rr2.BLL
{
	...
	{
		private readonly rr2.DAL.newsInfo dal=new rr2.DAL.newsInfo();
		public newsInfo()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public rr2.Model.newsInfo GetModelByCache(int newsId)
		{
			...
			return (rr2.Model.newsInfo)objModel;
		}
        ...
        {
            return dal.GetListmore(PageSize,PageIndex,strWhere);
        }
        /// <summary>
        /// 获得数据列表
        /// </summary>
        public List<rr2.Model.newsInfo> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<rr2.Model.newsInfo> DataTableToList(DataTable dt)
		{
			List<rr2.Model.newsInfo> modelList = new List<rr2.Model.newsInfo>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				rr2.Model.newsInfo model;
